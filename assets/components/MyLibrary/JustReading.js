...
//get just reading books and display it
function JustReading() {

    const [apiKey, setApiKey] = useState("google book api key");
    const url = 'https://localhost:8000/library/api/getJustReading/';
    ...
    if (error) {
        ...
        return(
            <div className="dataview-demo">
                <div className="card">
                    <DataView value={item} layout={layout} header={<Header title={'Reading now '} />}
