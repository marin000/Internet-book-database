...
//get favorite books and display it
function Favorite() {

    const [apiKey, setApiKey] = useState("google book api key");
    const url = 'https://localhost:8000/library/api/getFavorite/';
    ...
    if (error) {
        ...
        return(
            <div className="dataview-demo">
                <div className="card">
                    <DataView value={item} layout={layout} header={<Header title={'My favorite books'} />}
