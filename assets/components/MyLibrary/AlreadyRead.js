...
//get already read books and display it
function AlreadyRead() {

    const [apiKey, setApiKey] = useState("google book api key");
    const url = 'https://localhost:8000/library/api/getAlreadyRead/';
    ...
    if (error) {
        ...
        return(
            <div className="dataview-demo">
                <div className="card">
                    <DataView value={item} layout={layout} header={<Header title={'Already read books'} />}
