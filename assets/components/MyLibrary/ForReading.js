...
//get books for reading and display it
function ForReading() {

    const [apiKey, setApiKey] = useState("google book api key");
    const url = 'https://localhost:8000/library/api/getForReading/';
    ...
    if (error) {
        ...
        return(
            <div className="dataview-demo">
                <div className="card">
                    <DataView value={item} layout={layout} header={<Header title={'Books to read'} />}
